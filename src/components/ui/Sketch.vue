...
export default class Sketch extends mixins(colorMixin) {
  @Prop() public presetColors: Array<string> = presetColors;
  @Prop() public disableAlpha = false;
  @Prop() public disableFields = false;
  get hex() {
    let hex;
    if (this.colors.a < 1) {
