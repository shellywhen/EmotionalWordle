...
export default class App {
  constructor() {
    ...
    const storyConfiguration = {
      ...
      sectionList: [intro, wealthAndHealthConfig, builtInTriggers],
      ...
      onNarrationChangedFunction: ({ narrationClass }) => {
        ...
        selectAll(".navButton").classed("active", false);
        /** set navButtons with class narrationClass to .active */
        selectAll(`.navButton.${narrationClass}`).classed("active", true);
      }
    };
    ...
    selectAll(".navButton").on("click", function() {
